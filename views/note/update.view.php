...
<body>
    ...
    <div class="flex items-center justify-between gap-x-6 m-10">
        <h1 class="text-6xl text-gray-900">Update a note</h1>
        <a href="/notes">
            ...
            <div class="border border-gray-900/10 p-4 m-10 rounded-md">
                ...
                <div>
                    <!--<form method="POST" class="mt-6">
                        ...
                        <button class="rounded-md ml-5 bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"><i class="fa-solid fa-trash"></i> Delete</button>
                    </form>->
                </div>
            </div>
        </div>
