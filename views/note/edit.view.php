...
<body>
    ...
    <div class="flex items-center justify-between gap-x-6 m-10">
        <h1 class="text-6xl text-gray-900">Edit a note</h1>
        <a href="/notes">
        ...
        <div class="space-y-12">
            <div class="border border-gray-900/10 p-4 m-10 rounded-md">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 w-full focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                <input  id="title" type="text" name="title" placeholder="Note title" value="<?=$note['name'];?>" class="w-full border rounded-md border-gray-900/10 block bg-white py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6"/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    ...
                    <a href="/notes">
                        <button type="submit" class="rounded-md bg-gray-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-gray-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Cancel</button>
                    </a>
                </div>
            </div>
        </div>
